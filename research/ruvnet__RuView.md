...
appearances: [2026-04-20, 2026-04-21, 2026-04-22, 2026-04-23, 2026-04-24, 2026-05-16, 2026-05-23]
growth_appearances: [2026-04-20, 2026-04-21, 2026-04-22, 2026-04-23, 2026-04-24, 2026-05-16, 2026-05-23]
has_releases: true
latest_release: v1136
tags: [硬體, 框架, 自架, 資料主權]
domain: 硬體
form: 框架
themes: [自架, 資料主權]
...
### 2026-05-16
- **隔 22 天從 4-24 後歸隊**（絕對榜 #5，stars_total 57,269 / stars_today +1,865，growth_rate **3.26%**；增長榜 #5）；累計第 6 次上榜。22 天內 stars 從 49,719 漲至 57,269（+7,550，每日均增 343），冷卻期仍持續吸星而非歸零。
- 自 4-24 後新發兩版：[v0.6.4-esp32](https://github.com/ruvnet/RuView/releases/tag/v0.6.4-esp32)（2026-05-07，Tmr Svc 16 KiB stack + version drift fix）→ [v0.8.0](https://github.com/ruvnet/RuView/releases/tag/v0.8.0)（2026-05-14，Real-time CSI introspection / low-latency tap，ADR-099）；`latest_release` 由 v0.6.2-esp32 跳兩個 minor 至 **v0.8.0**。
- 5-14 v0.8.0 引入「即時 CSI introspection 低延遲 tap」是 22 天歸隊的主要催化劑——把 WiFi CSI 從事後分析推進到即時串流觀測，承接 4 月「看穿牆壁」敘事的下一階段「即時生命徵象」用例。

### 2026-05-23
- **隔 7 天從 5-16 後再度歸隊**（絕對榜 #3，stars_total 63,837 / stars_today +992，growth_rate **1.55%**；增長榜 #6）；累計第 7 次上榜。7 天內 stars 從 57,269 漲至 63,837（+6,568，每日均增 938）為冷卻期吸星速率提升。
- 自 5-16 v0.8.0 後 CI release pipeline 切換為「nightly auto-bump」模式，5-22 單日連發 [v1121](https://github.com/ruvnet/RuView/releases/tag/v1121) → [v1123](https://github.com/ruvnet/RuView/releases/tag/v1123) → ... → [v1136](https://github.com/ruvnet/RuView/releases/tag/v1136)，16 個版本同日推出皆為自動化 CI 產物（非人手 changelog 里程碑）；`latest_release` 跳轉至 **v1136**，但語意級重大版本仍為 5-14 v0.8.0。
- 第二次「無新人手 release 仍歸隊」事件——本檔 7 次上榜中除 v0.8.0 一輪外，其餘多由站外社群與 OpenAI / Anthropic 周邊「WiFi CSI 感知」討論餘波驅動，呈現「正典化老牌 repo 靠話題餘溫週期性回潮」型態。
