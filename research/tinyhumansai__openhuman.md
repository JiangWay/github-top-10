...
appearances: [2026-05-12, 2026-05-13, 2026-05-14, 2026-05-16, 2026-05-18, 2026-05-19, 2026-05-20, 2026-05-21]
growth_appearances: [2026-05-12, 2026-05-13, 2026-05-14, 2026-05-16, 2026-05-18, 2026-05-19, 2026-05-20, 2026-05-21]
has_releases: true
latest_release: v0.54.0
...
### 2026-05-18
- 隔 1 日從 5-16 後歸隊（5-17 缺席），**累計 5 次上榜**（5-12 ~ 5-14、5-16、5-18），同步推升「本站歷來個股累計上榜次數」紀錄；今日 stars_total **12,696**、stars_today **1,694**、growth_rate **13.34%**，**絕對榜由 #1 守 #1**（連續第 4 個曾上榜日守冠），增長榜 #3（前 2 名為今日 [tech-leads-club/agent-skills](https://github.com/tech-leads-club/agent-skills) 27.03% 與 [dograh-hq/dograh](https://github.com/dograh-hq/dograh) 15.35%，**首次同時被「兩檔真新進」壓過**）。
- 兩日內 stars_total 8,824 → 12,696（+43.9%），增量 3,872 顆星在無新 release 的條件下達成，反映**話題慣性**而非版本驅動；growth_rate 14.41% → 13.34% 連兩日下行（5-13 42.67% / 5-14 32.17% / 5-16 14.41% / 5-18 13.34%）呈典型熱度衰減曲線但仍有強動能。
- `latest_release` frontmatter 由 v0.53.40 更新為 **v0.53.43**（2026-05-13T20:10Z 已存在的更新，前次未捕捉），自 5-13 以來持續 5 天無新版為本檔上榜以來最長空檔。

### 2026-05-19
- 連 2 日守絕對榜 #1（5-18 ~ 5-19）為「絕對榜首隔日衛冕」連續第 5 個曾上榜日守冠；累計 6 次上榜（5-12／5-13／5-14／5-16／5-18／5-19）與 [CloakHQ/CloakBrowser](https://github.com/CloakHQ/CloakBrowser) 並列本站個股累計上榜新高；stars_total 12,696 → **16,628**（+31.0%）、stars_today 1,694 → **3,945**（+133%）為「老牌絕榜首」單日反彈最劇、growth_rate 13.34% → **23.72%** 反彈至本月個股第二高僅次於 5-13 自身 42.67%。
- 6 天後（自 5-13 v0.53.43）發出 [v0.54.0](https://github.com/tinyhumansai/openhuman/releases/tag/v0.54.0)（2026-05-19T07:17Z）—— minor 版號跳躍（v0.53→v0.54），主要為 observability 緩衝修補（Sentry 過濾 vision-disabled RAM-tier、transient backend_api / integrations）、PR 量級顯著高於 v0.53.43。`latest_release` 由 v0.53.43 更新為 **v0.54.0**。

### 2026-05-20
- **連 3 日守絕對榜 #1**（5-18 ~ 5-20），刷新本站「絕對榜首日連 3 日守冠」紀錄；累計 7 次上榜（5-12／5-13／5-14／5-16／5-18／5-19／5-20）寫**本站個股累計上榜次數新高**並與 [CloakHQ/CloakBrowser](https://github.com/CloakHQ/CloakBrowser) 並列。
- stars_total 16,628 → **20,650**（+24.2%，過 2 萬大關）、stars_today **3,991**（+1.2%，與昨日 3,945 幾乎持平的高水位）、growth_rate 23.72% → **19.33%** 連 2 日守在 20% 量級；絕對榜 #1，增長榜 #3（被 [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) 29.73% 與 [Imbad0202/academic-research-skills](https://github.com/Imbad0202/academic-research-skills) 22.85% 壓過，今日增長榜 #1 / #2 皆為「真新進 / 隔日新進」首見）。
- 自 [v0.54.0](https://github.com/tinyhumansai/openhuman/releases/tag/v0.54.0)（5-19）後 24 小時無新版；本檔的 `latest_release` 暫維持 v0.54.0。
