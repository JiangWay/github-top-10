...
appearances: [2026-05-06, 2026-05-07, 2026-05-08]
growth_appearances: [2026-05-06, 2026-05-07, 2026-05-08]
has_releases: true
...
### 2026-05-08
- 連榜 Day 3（5-06～5-08），絕對榜由 #4 升至 **#9**（位次後退但仍穩定持榜）、增長率榜由 #4 升至 **#6**（5.25% → 5.81%，+0.56pp 微升）；stars_today 772 → **899（+16.5%）**反彈；total stars 14,712 → **15,478（+766）**。
- Release 端**無新版本**，最新仍為 [2.5.2](https://github.com/docusealco/docuseal/releases/tag/2.5.2)（2026-05-04）；本週發行節奏穩定，未明顯加速。
- 連 3 日上榜為當日除 [Hmbown/DeepSeek-TUI](https://github.com/Hmbown/DeepSeek-TUI)（連 5 日）外連榜時間最長者，是「文件管理」類別本週的代表檔；今日 [docusealco/docuseal](https://github.com/docusealco/docuseal) 也是 10 檔中唯一非 AI 直接相關的留榜檔，凸顯其作為「自架替代品」基本盤的穩定特性。
