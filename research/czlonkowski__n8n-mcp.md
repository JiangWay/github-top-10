...
appearances: [2026-05-04, 2026-05-05, 2026-05-16]
growth_appearances: [2026-05-04, 2026-05-05, 2026-05-16]
has_releases: true
latest_release: v2.53.0
...
### 2026-05-16
- **隔 11 天從 5-05 後歸隊**，絕對榜 #8（stars_total 20,834 / stars_today +68），growth_rate **0.33%** 同時殿底增長榜 #10——是本檔三次上榜以來最低成長率，量級從 5-05 +497 縮到 5-16 +68（−86%），但 11 天 stars 仍累計 +994 至 20,834 突破 2 萬大關。
- 自 v2.50.3 後新發 8 版 patch / minor：[v2.50.4](https://github.com/czlonkowski/n8n-mcp/releases/tag/v2.50.4)（5-05）→ [v2.50.5](https://github.com/czlonkowski/n8n-mcp/releases/tag/v2.50.5)（5-05）→ [v2.51.0](https://github.com/czlonkowski/n8n-mcp/releases/tag/v2.51.0)（5-06）→ [v2.51.1](https://github.com/czlonkowski/n8n-mcp/releases/tag/v2.51.1)（5-06）→ [v2.51.2](https://github.com/czlonkowski/n8n-mcp/releases/tag/v2.51.2)（5-11）→ [v2.51.3](https://github.com/czlonkowski/n8n-mcp/releases/tag/v2.51.3)（5-11）→ [v2.52.0](https://github.com/czlonkowski/n8n-mcp/releases/tag/v2.52.0)（5-14）→ [v2.53.0](https://github.com/czlonkowski/n8n-mcp/releases/tag/v2.53.0)（5-14）；`latest_release` 由 v2.50.3 跨 3 個 minor 至 **v2.53.0**，11 天 8 版維持高頻迭代，與當日榜上低增量並存的「版本爆量 vs 注意力衰退」反差。
